...
- `lego` has been updated to 5.x, which has a changed CLI and state layout. See
  [upstream's v4 to v5 CLI migration guide](https://go-acme.github.io/lego/migration/cli/)
  for details.
